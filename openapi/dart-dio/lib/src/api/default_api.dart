...
import 'package:openapi/src/model/v1_track_score_response.dart';
...
class DefaultApi {
  ...
  Future<Response<V1AuthenticateGoogleResponse>> accountsAPIAuthenticateGoogle({ 
    ...
    final _path = r'/authenticate/google';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(V1AuthenticateGoogleRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
    ...
    return Response<V1AuthenticateGoogleResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<V1GetAccountProfilePictureResponse>> accountsAPIGetAccountProfilePicture({ 
    ...
    V1GetAccountProfilePictureResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1GetAccountProfilePictureResponse),
    ...
    return Response<V1GetAccountProfilePictureResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<V1IsAccountValidateResponse>> accountsAPIIsAccountValidate({ 
    ...
    V1IsAccountValidateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1IsAccountValidateResponse),
      ) as V1IsAccountValidateResponse;
    ...
    return Response<V1IsAccountValidateResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> accountsAPIRegisterUserToMobileBeta({ 
    required V1RegisterUserToMobileBetaRequest body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(V1RegisterUserToMobileBetaRequest);
      _bodyData = _serializers.serialize(body, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1GenerateQuizResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1GenerateQuizResponse>> notesAPIGenerateQuiz({ 
    required String groupId,
    required String noteId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    V1GenerateQuizResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1GenerateQuizResponse),
      ) as V1GenerateQuizResponse;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1ListScoreResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1ListScoreResponse>> notesAPIListScore({ 
    required String groupId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/groups/{groupId}/scores'.replaceAll('{' r'groupId' '}', encodeQueryParameter(_serializers, groupId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    V1ListScoreResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1ListScoreResponse),
      ) as V1ListScoreResponse;
    ...
    return Response<V1ListScoreResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1TrackScoreResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1TrackScoreResponse>> notesAPITrackScore({ 
    required String groupId,
    required String noteId,
    int? score,
    int? responses,
    ...
    V1TrackScoreResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1TrackScoreResponse),
      ) as V1TrackScoreResponse;
    ...
    return Response<V1TrackScoreResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1UpdateBlockIndexResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UpdateBlockIndexResponse>> notesAPIUpdateBlockIndex({ 
    required String groupId,
    required String noteId,
    required String blockId,
    ...
    final _path = r'/groups/{groupId}/notes/{noteId}/blocks/{blockId}/index'.replaceAll('{' r'groupId' '}', encodeQueryParameter(_serializers, groupId, const FullType(String)).toString()).replaceAll('{' r'noteId' '}', encodeQueryParameter(_serializers, noteId, const FullType(String)).toString()).replaceAll('{' r'blockId' '}', encodeQueryParameter(_serializers, blockId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    V1UpdateBlockIndexResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(V1UpdateBlockIndexResponse),
      ) as V1UpdateBlockIndexResponse;
    ...
    return Response<V1UpdateBlockIndexResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,

...
String parameterToString(dynamic value) {
  ...
  if (value is V1BlockType) {
    return V1BlockTypeTypeTransformer().encode(value).toString();
  }
  if (value is V1NoteExportFormat) {
    return V1NoteExportFormatTypeTransformer().encode(value).toString();
  }

...
const (
	RecommendationsAPI_GenerateWidgets_FullMethodName = "/noted.notes.v1.RecommendationsAPI/GenerateWidgets"
)
...
func (c *recommendationsAPIClient) GenerateWidgets(ctx context.Context, in *GenerateWidgetsRequest, opts ...grpc.CallOption) (*GenerateWidgetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, RecommendationsAPI_GenerateWidgets_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RecommendationsAPI_GenerateWidgets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationsAPI_GenerateWidgets_FullMethodName,
	}

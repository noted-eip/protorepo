...
func _AccountsAPI_SendValidationToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AccountsAPIServer).SendValidationToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountsAPI_SendValidationToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsAPIServer).SendValidationToken(ctx, req.(*SendValidationTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountsAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccountsAPI_SendValidationToken_Handler,
		},
		{
